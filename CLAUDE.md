- website url: https://www.qimu.dev/
...
- when I ask you to write a linkedin post for a blog post, create an md file for the linkedin post in the tmp folder at this project root, include blog post link.
